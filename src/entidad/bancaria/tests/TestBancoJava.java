...
public class TestBancoJava {
	...
	@BeforeClass
	public static void fixture() throws CUITInvalidoException, CUITYaAsignadoException,
			DepositoInicialInvalidoException, SinClientesException, ClienteInexistenteException,
	...
	@Test
	public void compararCuentas() throws TasaDeInteresNegativaException, DepositoInicialInvalidoException,
			SinClientesException, CUITInvalidoException {
		PersonaFisica persona = new PersonaFisica("20000000001", "Roberto Gomez Bolaños", domicilio, "0303456", "DNI",
				"00000000", "Soltero", "Psicólogo", "Doña Florinda");
		PersonaFisica[] personas = new PersonaFisica[1];
		personas[0] = persona;
		CajaDeAhorro cuenta1 = new CajaDeAhorro(personas, 0.1, 0.1, TipoDeMoneda.PESO);
		CajaDeAhorro cuenta2 = new CajaDeAhorro(personas, 0.1, 0.1, TipoDeMoneda.PESO);
	...
	@Test
	public void acreditarSaldoEnCajaDeAhorro()
			throws CBUInexistenteException, CuentaInhabilitadaException, DepositoInicialInvalidoException,
			SinClientesException, ClienteInexistenteException, CUITInvalidoException, TasaDeInteresNegativaException {
		String[] clientesCajaDeAhorro = new String[] { "20000000001" };
		int cbu = Banco.crearCajaDeAhorro(clientesCajaDeAhorro, 5000.0, 0.1, TipoDeMoneda.PESO);
	...
	public void acreditarSaldoEnCuentaCorriente()
			...
			CUITInvalidoException, SobregiroNegativoException, CBUInexistenteException, CuentaInhabilitadaException {

		String[] clientesCuentaCorriente = new String[] { "20000000001" };
		int cbu = Banco.crearCuentaCorriente(clientesCuentaCorriente, 100000.0, 10.0);
		Banco.depositoEnEfectivo(cbu, 1000.0);
		double calculoComision = 1000 * 0.03;
		Assert.assertEquals((101000.0 - calculoComision), Banco.buscarCuenta(cbu).getSaldo(), 0.1);
	}
	...
	@Test
	public void extraccionSaldoEnCajaDeAhorro() throws SaldoInsuficienteException, CuentaInhabilitadaException,
			CBUInexistenteException, DepositoInicialInvalidoException, SinClientesException,
			ClienteInexistenteException, CUITInvalidoException, TasaDeInteresNegativaException {
		String[] clientesCajaDeAhorro = new String[] { "20000000001" };
		int cbu = Banco.crearCajaDeAhorro(clientesCajaDeAhorro, 5000.0, 0.1, TipoDeMoneda.PESO);
	...
	@Test
	public void extraccionSaldoEnCuentaCorriente() throws SaldoInsuficienteException, CuentaInhabilitadaException,
			CBUInexistenteException, DepositoInicialInvalidoException, ClienteInexistenteException,
			SinClientesException, CUITInvalidoException, SobregiroNegativoException {
	...
	@Test
	public void buscarCliente() throws ClienteInexistenteException, CUITInvalidoException, CUITYaAsignadoException {
		Domicilio domicilio = new Domicilio("Calle Falsa 123", "1234asdf", "Un lugar", "Una provincia");
		Banco.agregarPersonaFisica("20034002501", "Jose perez", domicilio, "1234-4321", "DNI", "12345678", "Casado",
				"ingeniero", "amalia");
	...
	public void testTransferecias()
		...
		Assert.assertEquals((double) (saldoInicial - 1000.0), (double) Banco.buscarCuenta(1).getSaldo(), 0.1);
	...
	public void testCambioDeMoneda()
		...
		Assert.assertEquals((double) (saldoInicial + (1000.0 / Banco.getCotizacion())),
	...
	@Test
	public void testBuscarPersonaFisica()
			throws CUITInvalidoException, CUITYaAsignadoException, ClienteInexistenteException {

		Domicilio domicilio = new Domicilio("Calle Falsa 123", "1234asdf", "Un lugar", "Una provincia");
		Banco.agregarPersonaFisica("20034002601", "Jose schewer", domicilio, "1234-4321", "DNI", "12345678", "Casado",
				"ingeniero", "amalia");

		Assert.assertEquals(Banco.buscarCliente("20034002601").getDomicilio(), domicilio);
	...
	@Test
	public void testPagarInteres()
			throws DepositoInicialInvalidoException, SinClientesException, ClienteInexistenteException,
			CUITInvalidoException, TasaDeInteresNegativaException, CBUInexistenteException {
		double saldoInicial = Banco.buscarCuenta(1).getSaldo();
		Banco.pagarIntereses();
		Assert.assertEquals((saldoInicial + (saldoInicial * Banco.buscarCajaDeAhorro(1).getTasaDeInteres())),
				Banco.buscarCuenta(1).getSaldo(), 0.1);
	 ...
	 */
	@Test
	public void testCrearCuentaSinClientes() throws DepositoInicialInvalidoException, ClienteInexistenteException,
			SinClientesException, CUITInvalidoException, SobregiroNegativoException {
	...
	@Test
	public void testCuentaCorrienteSaldoMenorA10000() throws DepositoInicialInvalidoException,
			ClienteInexistenteException, SinClientesException, CUITInvalidoException, SobregiroNegativoException {
	...
	@Test
	public void testCUITYaAsignado() throws CUITInvalidoException, CUITYaAsignadoException, CBUInexistenteException {
	...
	@Test
	public void testClienteInexistente() throws ClienteInexistenteException, CUITInvalidoException {
	...
	@Test
	public void testTasaDeInteresNegativa() throws DepositoInicialInvalidoException, SinClientesException,
			ClienteInexistenteException, CUITInvalidoException, TasaDeInteresNegativaException {

		excepcionEsperada.expect(TasaDeInteresNegativaException.class);
		Banco.crearCajaDeAhorro(new String[] { "20000000001" }, 10000.0, -10.0, TipoDeMoneda.PESO);
	...
	public void testDepositoCuentaInhabilitada()
		...
		String[] clientesCuentaCorriente = new String[] { "20000000002" };
		int cbu = Banco.crearCuentaCorriente(clientesCuentaCorriente, 50000.0, 10000.0);
	...
	@Test
	public void testNumeroDeMovimientoInvalido() throws CBUInexistenteException, NumeroDeMovimientosInvalidosException {
	...
	@Test
	public void testCostoDeMantenimientonegativo() throws CostoDeMantenimientoNoPositivoException {
